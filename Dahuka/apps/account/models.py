...
class Customer(models.Model):
    ...
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES, default='male', verbose_name="Giới tính")
    birthday = models.DateField(null=True, blank=True, verbose_name="Ngày sinh")
    rank = models.CharField(max_length=50, default='Classic', verbose_name="Hạng thành viên")
...
class Address(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='addresses', verbose_name="Khách hàng")
